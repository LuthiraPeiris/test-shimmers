...
const SalesOrderItemsModal = ({ isOpen, onClose, salesOrder, items, onAddItem, onEditItem, onDeleteItem }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 modal-backdrop z-50 flex items-center justify-center" onClick={onClose}>
            <div className="bg-white rounded-xl shadow-xl w-full max-w-6xl mx-4 max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
                <div className="flex justify-between items-center p-6 border-b border-gray-200">
                    <div>
                        <h3 className="text-xl font-semibold text-gray-900">Sales Order Items</h3>
                        <p className="text-sm text-gray-600 mt-1">
                            {salesOrder.so_id} - {salesOrder.customer_name}
                        </p>
                    </div>
                                        ...
                                        <td colSpan="8" className="px-4 py-8 text-center text-gray-500">
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-sm text-gray-400">
                                                    Order ID: {salesOrder?.Sales_Order_ID || salesOrder?.so_id}
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
...
export default SalesOrderItemsModal;